...
D.removeSignificadoPalabra("Buddy", "El perrillo mas chulillo.");

cout<<D<<endl;

string a, b;

cout<<"Introduce dos claves para obtener la informacion entre ellas\n Clave 1: ";
cin >> a;

cout<<"Clave 2: ";
cin >> b;

Diccionario<string,string> C = D.getDiccionarioEntreClaves(a, b);
cout << C << endl;

D.cambiarClave("Sentencia", "ClaveCambiada");

cout << D << endl;

cout<<"Introduce una palabra para obtener su informacion asociada"<<endl;
cin>>a;
