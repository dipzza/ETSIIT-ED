...
// Añadir borrarEvento(int i) y getEvento(int)
...
/**
  * @brief Método de acceso al evento nºnum de la Fecha_Historica
  * @param num int con la posición del evento
  * @return string con el valor de str[num]
  */
  string getEvento (int num);
