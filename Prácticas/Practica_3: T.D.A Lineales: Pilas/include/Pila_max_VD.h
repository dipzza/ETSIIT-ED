 ...
 * tienen lugar en uno de los extremos denomaxado @e Tope. Una pila_max de longitud
 * @e n la denotamos

 * - [<a1,max{a1...an}>,<a2,max{a2...an}>,<a3,max{a3...an}>,..,<an,an>>

 * donde @e ai es el elemento de la posici�n i-�sima. Y @e max{ai,...aj} es el maximo del conjunto de * elementos que van desde @e ai a @e aj
...
class Pila_max{
  private:
    VectorDinamico<elemento> datos = VectorDinamico<elemento>(10);
    int num_datos=0;
  public:
    // ---------------  Constructores ----------------
    /**
